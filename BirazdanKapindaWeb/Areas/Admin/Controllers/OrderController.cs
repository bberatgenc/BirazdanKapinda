using Azure.Core;
using Azure;
using BirazdanKapinda.DataAccess.Repository;
...
namespace BirazdanKapindaWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult UpdateOrderDetail()
        {
            ...
            TempData["Success"] = "Sipariş detayları güncellemesi başarılı.";
        ...
        public IActionResult ShipOrder()
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Sipariş gönderimi başarılı.";
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
        }
        [HttpPost]
        [Authorize(Roles = SD.Role_Admin + "," + SD.Role_Employee)]
        public IActionResult CancelOrder()
        {
            ...
            _unitOfWork.Save();
            TempData["Success"] = "Sipariş iptali başarılı.";
            return RedirectToAction(nameof(Details), new { orderId = OrderVM.OrderHeader.Id });
