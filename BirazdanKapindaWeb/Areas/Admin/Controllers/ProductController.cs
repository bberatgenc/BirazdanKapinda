...
namespace BirazdanKapindaWeb.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (files != null)
                {
                    ...
                    foreach (IFormFile file in files)
                    {
                        ...
                        string productPath = @"img\product-" + productVM.Product.Id;
                ...
                TempData["success"] = "Ürün oluşturma/güncelleme başarılı.";
        ...
        public IActionResult Delete(int? id)
        {
            ...
            string productPath = @"img\product-" + id;
            string finalPath = Path.Combine(_webHostEnvironment.WebRootPath, productPath); // resim silmede sıkıntı var ürünü siliyor ama resmi dsilmiyo. Evet komple resimlerde problem var. Ekelme silme 
