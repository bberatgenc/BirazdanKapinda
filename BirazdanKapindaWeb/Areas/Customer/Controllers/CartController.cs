...
namespace BirazdanKapindaWeb.Areas.Customer.Controllers
{
    [Area("customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "Yeni Siparis - Birazdan Kapinda",
                $"<p>Yeni Siparis Olusturuldu - {orderHeader.Id}</p>");
